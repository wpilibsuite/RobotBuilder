...
public class ChildSelectionPropertyTest {
    ...
    public void testCopy() {
        ...
        assertArrayEquals("Copy should have the same validators.", cp.validators, copy.validators);
        ...
        assertArrayEquals("Copy should have the same validators.", cp.validators, copy2.validators);
    ...
    public void testSetValue() {
        ...
        cp.setValueAndUpdate("Arm");
        assertEquals("Arm", cp.value);
        cp.setValueAndUpdate("");
        assertEquals("Drive Train", cp.value);
        cp.setValueAndUpdate(null);
        assertEquals("Drive Train", cp.value);
        cp.setValueAndUpdate("Drive Train");
        assertEquals("Drive Train", cp.value);
        cp.setValueAndUpdate("Wrist");
