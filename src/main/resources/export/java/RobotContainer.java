...
public class RobotContainer {
  ...
  #@autogenerated_code("newObject", "    ")
      #parse("${exporter_path}RobotContainer-newObject.java")
  #end
  ...
  */
  ...
  private void configureButtonBindings() {
    #@autogenerated_code("buttonBindings", "        ")
    #parse("${exporter_path}RobotContainer-buttonsBindings.java")
    #end
  }
