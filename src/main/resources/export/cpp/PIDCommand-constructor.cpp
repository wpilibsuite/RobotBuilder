...
#else
#class($command.name)::#class($command.name)(): frc::PIDCommand("#class($command-name)", ${command.getProperty("P").getValue()}, ${command.getProperty("I").getValue()}, ${command.getProperty("D").getValue()}, ${command.getProperty("Period").getValue()}) {
 {
#end
