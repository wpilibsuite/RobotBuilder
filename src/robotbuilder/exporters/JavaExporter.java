    ...
    public void export(RobotTree robot) throws IOException {
        ...
        for (RobotComponent subsystem : robot.getSubsystems()) {
            ...
            if (subsystemExists(subsystem, robot.getRoot())) {
                ...
                template = template.replaceFirst("// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER([\\s\\S]*?)// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER",
                        "// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER\n"+generateSubsystemExport(subsystem)+"\n    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER");
            } else {
